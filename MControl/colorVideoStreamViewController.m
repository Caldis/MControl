...
#import "colorVideoStreamViewController.h"

@interface colorVideoStreamViewController ()

@end

@implementation colorVideoStreamViewController
...
- (IBAction)connectToServer:(id)sender {
    ...
    if(readStream && writeStream){
        ...
        [oStream write:&mode maxLength:1];
